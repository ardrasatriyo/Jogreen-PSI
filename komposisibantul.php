    ...
    <section class="section">
      ...
      <div class="row">
        <div class="col-12">
           <div class="card">
              <div class="card-body">
                  <h5 class="card-title">Komposisi Sampah Bantul</h5>

                    <!-- Filters -->
                    <div>
                        <label for="kabupatenFilter">Kabupaten:</label>
                        <select id="kabupatenFilter">
                            <option value="all">Bantul</option>
                      ...
                      document.addEventListener("DOMContentLoaded", () => {
                        let currentChart = null;
                            ...
                            const renderInitialChart = () => {
                                ...
                                let url = 'fetch_data_komp_bantul.php';
                                if (tahun !== 'all') {
                                    url += `?tahun=${tahun}`;
                                }
            ...
            <div class="card-body">
                ...
                <?php
                  ...
                  if ($_SERVER["REQUEST_METHOD"] == "POST") {
                      ...
                      $sql = "SELECT * FROM komposisi_jenis_sampah_bantul";
                  ...
                  <div class="card-body">
                    ...
                    <div class="datatable-dropdown">
                        <?php
                          ...
                          $sql = "SELECT * FROM komposisi_jenis_sampah_bantul LIMIT $limit";
                          $result = $conn->query($sql);
