        ...
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="komposisisampah.php">
              <i class="bi bi-circle"></i><span>Komposisi Sampah Keseluruhan</span>
            </a>
          </li>
    ...
    <section class="section">
      ...
      <div class="row">
        <div class="col-12">
           <div class="card">
              <div class="card-body">
                  <h5 class="card-title">Komposisi Sampah Keseluruhan</h5>
                    ...
                    <script>
                      document.addEventListener("DOMContentLoaded", () => {
                            ...
                            const renderInitialChart = () => {
                                ...
                                let url = 'fetch_data_komposisi.php';
                                if (tahun !== 'all') {
                                    url += `?tahun=${tahun}`;
                                }
            ...
            <div class="card-body">
                ...
                <?php
                  ...
                  if ($_SERVER["REQUEST_METHOD"] == "POST") {
                      ...
                      $sql = "SELECT * FROM komposisi_jenis_sampah";
                      ...
                      if (!empty($data)) {
                          $system_content = "Anda adalah AI yang hanya menjawab pertanyaa seputar sampah , permasalahannya, dan solusinya , jawabalah menggunakan bahasa indonesia";
