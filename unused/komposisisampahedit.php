                    ...
                    <script>
                      document.addEventListener("DOMContentLoaded", () => {
                            ...
                            const renderFilteredChart = () => {
                                ...
                                fetch(`filterdataedit.php?${params.toString()}`)
                                    ...
                                    .then(data => {
                                        ...
                                        const categories = Object.keys(data[0]).filter(key => key.startsWith('total_'));

                                        const seriesData = categories.map(category => {
                                            return data.reduce((total, item) => total + parseFloat(item[category]), 0);
                                        });
                                        ...
                                        currentChart = new ApexCharts(document.querySelector("#pieChart"), {
                                            ...
                                            labels: categories.map(category => category.replace('total_', '').replace('_', ' ')),
                                        });
