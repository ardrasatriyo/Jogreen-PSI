...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Komposisi Sampah KulonProgo</h1>
      <nav>
        <ol class="breadcrumb">
    ...
    <section class="section">
      ...
      <div class="row">
        <div class="col-12">
           <div class="card">
              <div class="card-body">
                  <h5 class="card-title">Komposisi Sampah KulonProgo</h5>

                    <!-- Filters -->
                    <div>
                        <label for="kabupatenFilter">Kabupaten:</label>
                        <select id="kabupatenFilter">
                            <option value="all">Kab KulonProgo</option>
                      ...
                      document.addEventListener("DOMContentLoaded", () => {
                        let currentChart = null;
                            ...
                            const renderInitialChart = () => {
                                ...
                                let url = 'fetch_data_komp_kulon.php';
                                if (tahun !== 'all') {
                                    url += `?tahun=${tahun}`;
                                }
            ...
            <div class="card-body">
                ...
                <?php
                  ...
                  if ($_SERVER["REQUEST_METHOD"] == "POST") {
                      ...
                      $sql = "SELECT * FROM komposisi_jenis_sampah_kulonprogo";
                  ...
                  <div class="card-body">
                    ...
                    <div class="datatable-dropdown">
                        <?php
                          ...
                          $sql = "SELECT * FROM komposisi_jenis_sampah_kulonprogo LIMIT $limit";
                          $result = $conn->query($sql);
