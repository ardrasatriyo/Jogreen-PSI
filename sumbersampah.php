...
<head>
  ...
  <title>Jogreen-Sumber Sampah</title>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Sumber Sampah</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      ...
      <div class="row">
        <div class="col-12">
           <div class="card">
              <div class="card-body">
                  <h5 class="card-title">Komposisi Sampah Berdasarkan Sumber Sampah</h5>
                    ...
                    <script>
                      document.addEventListener("DOMContentLoaded", () => {
                            ...
                            const renderInitialChart = () => {
                                ...
                                fetch(url)
                                    ...
                                    .then(data => {
                                      ...
                                      const seriesData = [
                                          parseFloat(totals.total_rumah_tangga),
                                          parseFloat(totals.total_perkantoran),
                                          parseFloat(totals.total_pasar),
                                          parseFloat(totals.total_perniagaan),
                                          parseFloat(totals.total_fasilitas_publik),
                                          parseFloat(totals.total_kawasan),
                                          parseFloat(totals.total_lain),
                                      ];
                            ...
                            const renderFilteredChart = () => {
                                ...
                                fetch(`filterdata4.php?${params.toString()}`)
                                    .then(response => response.json())
                                    .then(data => {
                                      const totals = data[0];
                  ...
                  if ($_SERVER["REQUEST_METHOD"] == "POST") {
                      ...
                      if (!empty($data)) {
                          ...
                          foreach ($data as $item) {
                           ...
                           ", Sisa Makanan: " . $item['rumah_tangga'] . 
                           ", Kayu Ranting: " . $item['perkantoran'] . 
                           ", Kertas Karton: " . $item['pasar'] . 
                           ", Plastik: " . $item['perniagaan'] . 
                           ", Logam: " . $item['fasilitas_publik'] . 
                           ", Kain: " . $item['kawasan'] . 
                           ", Karet Kulit: " . $item['lain'] . 
                           ", Tahun: " . $item['tahun'] . 
                           "; ";
                          }
      ...
      <div class="row">
          <div class="col-lg-12">
              <div class="card">
                  <div class="card-body">
                    <h5 class="card-title">Tabel Sumber Sampah</h5>
                    ...
                    <div class="datatable-dropdown">
                        <?php
                          ...
                          $sql = "SELECT * FROM sumber_sampah LIMIT $limit";
                          $result = $conn->query($sql);
                            ...
                            <tbody>
                                    ...
                                    if ($result->num_rows > 0) {
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            echo "<td>" . $row["rumah_tangga"] . "</td>";
                                            echo "<td>" . $row["perkantoran"] . "</td>";
                                            echo "<td>" . $row["pasar"] . "</td>";
                                            echo "<td>" . $row["perniagaan"] . "</td>";
                                            echo "<td>" . $row["fasilitas_publik"] . "</td>";
                                            echo "<td>" . $row["kawasan"] . "</td>";
                                            echo "<td>" . $row["lain"] . "</td>";
                                            echo "</tr>";
                                        }
                                    } else {
